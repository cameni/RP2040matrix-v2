...
#define     DKGRAY                      RGB(0x0c, 0x0c, 0x0c)
#define     GRAY                        RGB(0x38, 0x38, 0x38)
#define     LTGRAY                      RGB(0x5B, 0x5B, 0x5B)
#define     WHITE                       RGB(0xFF, 0xFF, 0xFF)
#define     DKRED                       RGB(0x1e, 0x00, 0x00)
#define     RED                         RGB(0xFF, 0x00, 0x00)
#define     LTRED                       RGB(0xFF, 0x0c, 0x0c)
#define     DKGREEN                     RGB(0x00, 0x1e, 0x00)
#define     GREEN                       RGB(0x00, 0xDD, 0x00)
#define     LTGREEN                     RGB(0x14, 0xFF, 0x14)
#define     DKBLUE                      RGB(0x00, 0x00, 0x1e)
#define     BLUE                        RGB(0x01, 0x01, 0xFF)
#define     LTBLUE                      RGB(0x1E, 0x1E, 0xFF)
#define     DKYELLOW                    RGB(0x38, 0x38, 0x00)
#define     YELLOW                      RGB(0xFF, 0xFF, 0x00)
#define     LTYELLOW                    RGB(0xFF, 0xFF, 0x38)
#define     DKMAGENTA                   RGB(0x1E, 0x00, 0x1E)
#define     MAGENTA                     RGB(0xFF, 0x00, 0xFF)
#define     LTMAGENTA                   RGB(0xFF, 0x1E, 0xFF)
#define     DKCYAN                      RGB(0x00, 0x1E, 0x1E)
#define     CYAN                        RGB(0x00, 0x71, 0x71)
#define     LTCYAN                      RGB(0x1E, 0xFF, 0xFF)
#define     GOLD                        RGB(0x49, 0x49, 0x06)
#define     ORANGE                      RGB(0xFF, 0x38, 0x00)
#define     DKORANGE                    RGB(0x38, 0x0C, 0x00)
#define     LTORANGE                    RGB(0xFF, 0x71, 0x03)
