...
#define DISPLAY_WIDTH_SCAN (DISPLAY_WIDTH/4)
...
#define DISPLAY_HEIGHT  64
#define DISPLAY_WIDTH_SCAN (DISPLAY_WIDTH/4)    // 4 pixels per framebuffer word, XXbgrbgr
...
#define DISPLAY_WIDTH_SCAN (DISPLAY_WIDTH/2)
